...
This is a barebones template bot made with [Dressed](https://dressed.js.org) that is compatible with Node, Bun, and Deno.
...
1. Clone the project:
   ...
   ```sh
   bun create dressed my-bot bare
   cd my-bot
   ```
...
You can try editing your bot by modifying `index.ts`.
...
You can check out [the GitHub repository](https://github.com/inbestigator/dressed) - your feedback
