import { Button, type ComponentInteraction } from "@dressed/dressed";
...
export default async function sweep(interaction: ComponentInteraction, { x, y }: Params<typeof pattern>) {
